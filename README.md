...
[![Build Status](https://img.shields.io/travis/tsoka/open-event-attendee-android/development.svg?label=development)](https://travis-ci.org/tsoka/open-event-attendee-android?branch=development)
[![Build Status](https://img.shields.io/travis/tsoka/open-event-attendee-android/master.svg?label=master)](https://travis-ci.org/tsoka/open-event-attendee-android?branch=master)
[![Join the chat at https://gitter.im/tsoka/open-event-android](https://badges.gitter.im/tsoka/open-event-android.svg)](https://gitter.im/tsoka/open-event-android?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
Our chat channel is on gitter [here](https://gitter.im/tsoka/open-event-attendee-android)
...
A native Android app using Kotlin for writing code and [Open event server](https://github.com/tsoka/open-event-server) for API.
 ...
 * **apk** This branch contains two apk's, that are automatically generated on the merged pull request a) debug apk and b) release apk.
    - Please download and test the app that is using the code from the development and master branches [here](https://github.com/tsoka/open-event-attendee-android/tree/apk).
### Code practices
